...
const navItems = [
  ...
  { href: "/create", label: "Create Post", icon: "M12 4v16m8-8H4" },
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white flex flex-col min-h-screen">
      <div className="px-6 py-5 border-b border-gray-800">
        <h1 className="text-xl font-bold">Link Agent</h1>
        <p className="text-xs text-gray-400 mt-1">LinkedIn Content AI</p>
      </div>
